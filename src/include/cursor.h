...
#define WT_CURSOR_STATIC_INIT(n, get_key, get_value, get_raw_key_value, set_key, set_value,        \
  ...
  reserve, read_stable, reconfigure, largest_key, bound, cache, reopen, checkpoint_id, close)      \
    static const WT_CURSOR n = {                                                                   \
      ...
      reset, search, search_near, insert, modify, update, remove, reserve, read_stable,            \
